...
from starknet_py.net.models.transaction import (DeployAccount, compute_deploy_account_transaction_hash,
                                                AccountTransaction)

from data.models import Implementations


ACTUAL_IMPL = Implementations.Braavos.contract_address
...
async def _sign_deploy_account_transaction_braavos(transaction: DeployAccount, private_key: int):
    ...
    return [r, s, ACTUAL_IMPL, 0, 0, 0, 0, 0, 0, 0]
